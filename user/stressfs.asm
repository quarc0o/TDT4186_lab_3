...
printint(int fd, int xx, int base, int sgn)
{
 ...
 4a2:	4c250513          	addi	a0,a0,1218 # 960 <digits>
 4a6:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 5a6:	36670713          	addi	a4,a4,870 # 908 <malloc+0x12e>
 ...
 630:	334b8b93          	addi	s7,s7,820 # 960 <digits>
 ...
 684:	28090913          	addi	s2,s2,640 # 900 <malloc+0x126>
        while(*s != 0){
