...
main(int argc, char *argv[])
{
  ...
  34:	820a8a93          	addi	s5,s5,-2016 # 850 <malloc+0xf4>
  ...
  76:	7e658593          	addi	a1,a1,2022 # 858 <malloc+0xfc>
  7a:	4505                	li	a0,1
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 424:	4a050513          	addi	a0,a0,1184 # 8c0 <digits>
 428:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 528:	34470713          	addi	a4,a4,836 # 868 <malloc+0x10c>
 ...
 5b2:	312b8b93          	addi	s7,s7,786 # 8c0 <digits>
 ...
 606:	25e90913          	addi	s2,s2,606 # 860 <malloc+0x104>
        while(*s != 0){
