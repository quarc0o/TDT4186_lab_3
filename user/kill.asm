...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3fa:	4a250513          	addi	a0,a0,1186 # 898 <digits>
 3fe:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4fe:	34670713          	addi	a4,a4,838 # 840 <malloc+0x10e>
 ...
 588:	314b8b93          	addi	s7,s7,788 # 898 <digits>
 ...
 5dc:	26090913          	addi	s2,s2,608 # 838 <malloc+0x106>
        while(*s != 0){
