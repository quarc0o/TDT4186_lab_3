...
wc(int fd, char *name)
{
  ...
  3c:	908a0a13          	addi	s4,s4,-1784 # 940 <malloc+0xe8>
        inword = 0;
  40:	4b81                	li	s7,0
  while((n = read(fd, buf, sizeof(buf))) > 0){
  ...
  aa:	8b250513          	addi	a0,a0,-1870 # 958 <malloc+0x100>
  ...
  d8:	87450513          	addi	a0,a0,-1932 # 948 <malloc+0xf0>
...
main(int argc, char *argv[])
{
 ...
 154:	81858593          	addi	a1,a1,-2024 # 968 <malloc+0x110>
 158:	4501                	li	a0,0
 ...
 174:	80050513          	addi	a0,a0,-2048 # 970 <malloc+0x118>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 520:	4cc50513          	addi	a0,a0,1228 # 9e8 <digits>
 524:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 624:	37070713          	addi	a4,a4,880 # 990 <malloc+0x138>
 ...
 702:	28a90913          	addi	s2,s2,650 # 988 <malloc+0x130>
        while(*s != 0){
