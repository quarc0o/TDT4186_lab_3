...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3f6:	4be50513          	addi	a0,a0,1214 # 8b0 <digits>
 3fa:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4fa:	36270713          	addi	a4,a4,866 # 858 <malloc+0x12a>
 ...
 584:	330b8b93          	addi	s7,s7,816 # 8b0 <digits>
 ...
 5d8:	27c90913          	addi	s2,s2,636 # 850 <malloc+0x122>
        while(*s != 0){
