...
void forktest(void)
{
  ...
  46:	85e50513          	addi	a0,a0,-1954 # 8a0 <malloc+0xec>
  ...
  70:	854b0b13          	addi	s6,s6,-1964 # 8c0 <malloc+0x10c>
            printf("CHILD %d: %d\n", n, i);
  74:	00001a97          	auipc	s5,0x1
  78:	83ca8a93          	addi	s5,s5,-1988 # 8b0 <malloc+0xfc>
    for (unsigned long long i = 0; i < 1000; i++)
  ...
  ac:	82850513          	addi	a0,a0,-2008 # 8d0 <malloc+0x11c>
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 51e:	18090c63          	beqz	s2,6b6 <vprintf+0x1b4>
 522:	8aaa                	mv	s5,a0
 524:	8bb2                	mv	s7,a2
 ...
 530:	4b55                	li	s6,21
 532:	a839                	j	550 <vprintf+0x4e>
        putc(fd, c);
 534:	85ca                	mv	a1,s2
 536:	8556                	mv	a0,s5
 538:	00000097          	auipc	ra,0x0
 53c:	efc080e7          	jalr	-260(ra) # 434 <putc>
 540:	a019                	j	546 <vprintf+0x44>
    } else if(state == '%'){
 542:	01498d63          	beq	s3,s4,55c <vprintf+0x5a>
  for(i = 0; fmt[i]; i++){
 546:	0485                	addi	s1,s1,1
 548:	fff4c903          	lbu	s2,-1(s1)
 54c:	16090563          	beqz	s2,6b6 <vprintf+0x1b4>
    if(state == 0){
 550:	fe0999e3          	bnez	s3,542 <vprintf+0x40>
      if(c == '%'){
 554:	ff4910e3          	bne	s2,s4,534 <vprintf+0x32>
        state = '%';
 558:	89d2                	mv	s3,s4
 55a:	b7f5                	j	546 <vprintf+0x44>
      if(c == 'd'){
 55c:	13490263          	beq	s2,s4,680 <vprintf+0x17e>
 560:	f9d9079b          	addiw	a5,s2,-99
 564:	0ff7f793          	zext.b	a5,a5
 568:	12fb6563          	bltu	s6,a5,692 <vprintf+0x190>
 56c:	f9d9079b          	addiw	a5,s2,-99
 570:	0ff7f713          	zext.b	a4,a5
 574:	10eb6f63          	bltu	s6,a4,692 <vprintf+0x190>
 578:	00271793          	slli	a5,a4,0x2
 57c:	00000717          	auipc	a4,0x0
 580:	36c70713          	addi	a4,a4,876 # 8e8 <malloc+0x134>
 ...
 59e:	ebc080e7          	jalr	-324(ra) # 456 <printint>
 5a2:	8bca                	mv	s7,s2
      } else {
 ...
 5ba:	ea0080e7          	jalr	-352(ra) # 456 <printint>
 5be:	8bca                	mv	s7,s2
      state = 0;
 5c0:	4981                	li	s3,0
 5c2:	b751                	j	546 <vprintf+0x44>
 ...
 5d6:	e84080e7          	jalr	-380(ra) # 456 <printint>
 5da:	8bca                	mv	s7,s2
      state = 0;
 5dc:	4981                	li	s3,0
 5de:	b7a5                	j	546 <vprintf+0x44>
 ...
 60a:	33ab8b93          	addi	s7,s7,826 # 940 <digits>
 ...
 62a:	8be2                	mv	s7,s8
      state = 0;
 62c:	4981                	li	s3,0
 62e:	bf21                	j	546 <vprintf+0x44>
        s = va_arg(ap, char*);
 630:	008b8993          	addi	s3,s7,8
 634:	000bb903          	ld	s2,0(s7)
        if(s == 0)
 638:	02090163          	beqz	s2,65a <vprintf+0x158>
        while(*s != 0){
 63c:	00094583          	lbu	a1,0(s2)
 640:	c9a5                	beqz	a1,6b0 <vprintf+0x1ae>
          putc(fd, *s);
 642:	8556                	mv	a0,s5
 ...
 652:	f9e5                	bnez	a1,642 <vprintf+0x140>
        s = va_arg(ap, char*);
 654:	8bce                	mv	s7,s3
      state = 0;
 656:	4981                	li	s3,0
 658:	b5fd                	j	546 <vprintf+0x44>
          s = "(null)";
 65a:	00000917          	auipc	s2,0x0
 65e:	28690913          	addi	s2,s2,646 # 8e0 <malloc+0x12c>
        while(*s != 0){
 662:	02800593          	li	a1,40
 666:	bff1                	j	642 <vprintf+0x140>
 ...
 6a8:	d90080e7          	jalr	-624(ra) # 434 <putc>
      state = 0;
 6ac:	4981                	li	s3,0
 6ae:	bd61                	j	546 <vprintf+0x44>
        s = va_arg(ap, char*);
 6b0:	8bce                	mv	s7,s3
      state = 0;
 6b2:	4981                	li	s3,0
 6b4:	bd49                	j	546 <vprintf+0x44>
    }
  }
}
 ...
 6c0:	7a02                	ld	s4,32(sp)
 6c2:	6ae2                	ld	s5,24(sp)
 6c4:	6b42                	ld	s6,16(sp)
 6c6:	6ba2                	ld	s7,8(sp)
 6c8:	6c02                	ld	s8,0(sp)
...
malloc(uint nbytes)
{
 ...
 88e:	b6a080e7          	jalr	-1174(ra) # 3f4 <sbrk>
  if(p == (char*)-1)
