...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3c0:	48450513          	addi	a0,a0,1156 # 840 <digits>
 3c4:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4c4:	32870713          	addi	a4,a4,808 # 7e8 <malloc+0xf0>
 ...
 54e:	2f6b8b93          	addi	s7,s7,758 # 840 <digits>
 ...
 5a2:	24290913          	addi	s2,s2,578 # 7e0 <malloc+0xe8>
        while(*s != 0){
