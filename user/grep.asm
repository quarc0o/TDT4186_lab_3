...
00000000000001ec <main>:
{
 ...
 25e:	80658593          	addi	a1,a1,-2042 # a60 <malloc+0xe8>
 262:	4509                	li	a0,2
 ...
 294:	7f050513          	addi	a0,a0,2032 # a80 <malloc+0x108>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 640:	4bc50513          	addi	a0,a0,1212 # af8 <digits>
 644:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 744:	36070713          	addi	a4,a4,864 # aa0 <malloc+0x128>
 ...
 7ce:	32eb8b93          	addi	s7,s7,814 # af8 <digits>
 ...
 822:	27a90913          	addi	s2,s2,634 # a98 <malloc+0x120>
        while(*s != 0){
