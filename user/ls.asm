...
ls(char *path)
{
 ...
 128:	99c50513          	addi	a0,a0,-1636 # ac0 <malloc+0x120>
 ...
 166:	92e58593          	addi	a1,a1,-1746 # a90 <malloc+0xf0>
 16a:	4509                	li	a0,2
 ...
 17c:	93058593          	addi	a1,a1,-1744 # aa8 <malloc+0x108>
 180:	4509                	li	a0,2
 ...
 1ae:	92650513          	addi	a0,a0,-1754 # ad0 <malloc+0x130>
 ...
 1f2:	8faa0a13          	addi	s4,s4,-1798 # ae8 <malloc+0x148>
        printf("ls: cannot stat %s\n", buf);
 1f6:	00001a97          	auipc	s5,0x1
 1fa:	8b2a8a93          	addi	s5,s5,-1870 # aa8 <malloc+0x108>
...
main(int argc, char *argv[])
{
 ...
 2bc:	84050513          	addi	a0,a0,-1984 # af8 <malloc+0x158>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 668:	4fc50513          	addi	a0,a0,1276 # b60 <digits>
 66c:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 76c:	3a070713          	addi	a4,a4,928 # b08 <malloc+0x168>
 ...
 7f6:	36eb8b93          	addi	s7,s7,878 # b60 <digits>
 ...
 84a:	2ba90913          	addi	s2,s2,698 # b00 <malloc+0x160>
        while(*s != 0){
...
malloc(uint nbytes)
{
 ...
 9fc:	62878793          	addi	a5,a5,1576 # 1020 <base>
