...
main(int argc, char *argv[])
{
 ...
 104:	80058593          	addi	a1,a1,-2048 # 900 <malloc+0x116>
 108:	4509                	li	a0,2
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 5b6:	36e70713          	addi	a4,a4,878 # 920 <malloc+0x136>
 ...
 640:	33cb8b93          	addi	s7,s7,828 # 978 <digits>
 ...
 694:	28890913          	addi	s2,s2,648 # 918 <malloc+0x12e>
        while(*s != 0){
...
malloc(uint nbytes)
{
 ...
 846:	9ce78793          	addi	a5,a5,-1586 # 1210 <base>
