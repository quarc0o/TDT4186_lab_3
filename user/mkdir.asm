...
main(int argc, char *argv[])
{
  ...
  40:	7f458593          	addi	a1,a1,2036 # 830 <malloc+0xec>
  44:	4509                	li	a0,2
  ...
  5e:	7ee58593          	addi	a1,a1,2030 # 848 <malloc+0x104>
  62:	4509                	li	a0,2
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 40c:	4c050513          	addi	a0,a0,1216 # 8c8 <digits>
 410:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 510:	36470713          	addi	a4,a4,868 # 870 <malloc+0x12c>
 ...
 59a:	332b8b93          	addi	s7,s7,818 # 8c8 <digits>
 ...
 5ee:	27e90913          	addi	s2,s2,638 # 868 <malloc+0x124>
        while(*s != 0){
